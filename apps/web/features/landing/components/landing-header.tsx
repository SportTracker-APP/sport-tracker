...
export function LandingHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-emerald-100/[0.08] bg-[#03110d]/76 backdrop-blur-2xl">
      <nav
      ...
      >
        ...
        >
          <span className="flex h-11 w-11 items-center justify-center rounded-2xl border border-emerald-100/14 bg-emerald-300/[0.08] shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] transition group-hover:border-emerald-200/28">
            <Mountain className="h-5 w-5 text-emerald-100" aria-hidden="true" />
          </span>
          <span>
      ...
      {isOpen ? (
        <div className="border-t border-emerald-100/[0.08] bg-[#03110d]/96 px-5 py-5 shadow-2xl lg:hidden">
