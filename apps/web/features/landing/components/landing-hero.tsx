  ...
  return (
    <section className="relative isolate flex min-h-[calc(100svh-5rem)] overflow-hidden px-5 pt-14 pb-20 sm:px-6 lg:min-h-[calc(100vh-5rem)] lg:px-10 lg:pt-16 lg:pb-16 2xl:px-12">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute top-24 left-[-14rem] h-[34rem] w-[34rem] rounded-full bg-[#071713]/70 blur-3xl" />
      ...
      <div className="mx-auto grid w-full max-w-[118rem] items-center gap-12 lg:grid-cols-[0.88fr_1.12fr] 2xl:gap-16">
        <div className="relative z-10 max-w-3xl">
          ...
          <h1 className="mt-7 text-5xl font-semibold tracking-[-0.04em] text-white min-[1536px]:text-[5.8rem] min-[1800px]:text-[6.45rem] sm:text-6xl lg:text-7xl">
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/register"
              className="inline-flex min-h-13 items-center justify-center gap-2 rounded-2xl bg-[#2f7a63] px-6 text-sm font-bold text-white shadow-[0_22px_60px_rgba(47,122,99,0.34)] transition hover:-translate-y-0.5 hover:bg-emerald-500 focus-visible:ring-2 focus-visible:ring-emerald-100 focus-visible:outline-none"
            >
              Créer mon carnet
