...
export function ProgressionSection() {
  return (
    ...
    >
      <div className="pointer-events-none absolute -top-10 right-8 h-72 w-72 rounded-full bg-emerald-300/10 blur-3xl" />
      <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
        ...
        <div className="rounded-[2rem] border border-emerald-100/[0.11] bg-[linear-gradient(145deg,rgba(16,42,34,0.72),rgba(11,31,25,0.62),rgba(47,122,99,0.08))] p-5 shadow-[0_28px_100px_rgba(0,0,0,0.22)] backdrop-blur-2xl sm:p-6">
          <div className="grid gap-3 sm:grid-cols-2">
            {metrics.map((metric) => (
              <div
                key={metric.label}
                className="rounded-[1.4rem] border border-emerald-100/[0.09] bg-[#03110d]/58 p-5"
              >
          ...
          <div className="mt-3 grid gap-3 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-[1.4rem] border border-emerald-100/[0.09] bg-[#03110d]/58 p-5">
