...
export const metadata: Metadata = {
  title: "Confidentialite | Montara",
  description: "Politique de confidentialite de Montara.",
};
...
const privacySections = [
  {
    ...
    paragraphs: [
      "Montara est une application de carnet outdoor qui permet de suivre des activites sportives, des sommets, des objectifs et des statistiques personnelles.",
      "Le responsable du traitement des donnees est l'editeur de Montara. Pour toute demande relative aux donnees personnelles, l'utilisateur peut contacter l'equipe Montara via l'adresse de support indiquee dans l'application ou dans les communications officielles du service.",
    ],
  },
  {
    title: "2. Donnees collectees",
    paragraphs: [
      "Montara collecte uniquement les donnees necessaires au fonctionnement du service : adresse email, nom ou prenom affiche, mot de passe chiffre, statut de verification du compte, preferences et parametres de compte.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Montara n'utilise pas les donnees sportives personnelles pour vendre des profils publicitaires individualises.",
    ],
  },
  {
    title: "4. Base legale",
    paragraphs: [
      ...
      "Certains traitements de securite, de prevention des abus et d'amelioration technique reposent sur l'interet legitime de Montara a maintenir un service fiable et protege.",
  ...
  },
  {
    ...
    paragraphs: [
      "Montara peut envoyer des emails strictement lies au fonctionnement du compte : verification d'adresse email, reinitialisation du mot de passe, confirmation de changement de mot de passe, notifications importantes de securite ou messages necessaires a l'utilisation du service.",
  ...
  },
  {
    ...
    paragraphs: [
      "Si l'utilisateur connecte une integration comme Strava, Montara traite les donnees transmises par ce service uniquement pour fournir les fonctionnalites demandees : import, affichage, suivi et statistiques.",
      "L'utilisateur peut retirer l'acces a une integration depuis les parametres du service concerne ou depuis Montara lorsque cette fonctionnalite est disponible.",
      "Montara peut s'appuyer sur des prestataires techniques pour l'hebergement, l'envoi d'emails, l'analyse d'erreurs ou la mesure technique du service. Ces prestataires ne traitent les donnees que pour le compte de Montara et selon les finalites prevues.",
    ],
  },
  {
    ...
    paragraphs: [
      ...
      "En cas de suppression du compte, Montara supprime ou anonymise les donnees associees dans un delai raisonnable, sous reserve des obligations legales ou de securite qui imposeraient une conservation temporaire.",
  ...
  },
  {
    title: "8. Securite",
    paragraphs: [
      "Montara applique des mesures raisonnables de securite : mots de passe haches, verification des droits d'acces, protection des routes sensibles, validation des donnees et limitation de l'exposition des informations sensibles dans les journaux techniques.",
  ...
  },
  {
    ...
    paragraphs: [
      "Montara peut utiliser des cookies ou du stockage local pour maintenir la session, memoriser certaines preferences d'affichage et assurer le fonctionnement normal de l'application.",
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
        ...
        <section className="space-y-5">
          ...
          <p className="max-w-3xl text-base leading-8 text-zinc-400">
            ...
            comment Montara collecte, utilise, protege et conserve les donnees
