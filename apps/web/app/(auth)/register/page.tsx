...
export default function RegisterPage() {
  return (
    <main className="app-auth-page relative min-h-screen overflow-hidden bg-black text-white">
      ...
      {/* BIG LEFT GLOW */}
      <div className="absolute top-1/2 left-[-150px] h-[650px] w-[650px] -translate-y-1/2 rounded-full bg-violet-700/20 blur-3xl" />

      {/* RIGHT GLOW */}
      <div className="absolute top-[10%] right-[-120px] h-[500px] w-[500px] rounded-full bg-fuchsia-600/20 blur-3xl" />

      {/* CENTER LINE */}
      <div className="absolute top-0 left-1/2 hidden h-full w-px bg-white/5 lg:block" />
      ...
      <div className="relative z-10 grid min-h-screen lg:grid-cols-2">
        ...
        <div className="app-auth-left relative hidden flex-col justify-center overflow-hidden border-r border-white/5 px-16 py-12 lg:flex">
          ...
          <div className="absolute top-12 left-16 flex items-center gap-4">
            <div className="app-auth-logo flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-violet-500/10 backdrop-blur-xl">
        ...
        {/* RIGHT PANEL */}
        <div className="app-auth-right relative flex items-center justify-center overflow-hidden p-6 lg:p-12">
          {/* RIGHT ORB */}
